...
void eOverPStability(int kine=8, 
		     int mag=100, 
		     int pass=2, 
		     int N=12,
		     double mean=0.979,
  ...
  graphErrors_eoverp->SetTitle(Form("R_{sf} vs. N sig (#sigma = %.3f); N sig; R_{sf}",sigma));
  ...
  graphErrors_eoverp->GetYaxis()->SetTitleOffset(1.0);
