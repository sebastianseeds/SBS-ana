...
void dyStability(int kine=8, 
  ...
  graphErrors_dy->SetTitle(Form("R_{sf} vs. N sig (#sigma = %.3f m); N sig; R_{sf}",sigma));
  ...
  graphErrors_dy->GetYaxis()->SetTitleOffset(1.0);
